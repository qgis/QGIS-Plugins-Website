...
from plugins.utils import extract_version, get_qgis_versions
...
class TestQGISGitHubReleases(TestCase):
    ...
    def test_get_qgis_versions(self, mock_get):
        ...
        mock_response_github.json.return_value = [
            {
                "tag_name": "final_3_22_10",
                "html_url": "https://github.com/qgis/QGIS/releases/tag/final-3_22_10",
            },
            {
                "tag_name": "beta_3_23_0",
                "html_url": "https://github.com/qgis/QGIS/releases/tag/beta-3_23_0",
            },
        ]

        mock_response_qgis = Mock()
        mock_response_qgis.status_code = 200
        mock_response_qgis.json.return_value = {"dev": {"version": "3.24"}}
