...
def _make_security_rule(check_code, check_category="bandit", severity="warning",
...
class SecurityRuleSkipFormTest(TestCase):
    ...
    def _form_choices(self):
        ...
        return [choice_id for choice_id, _ in form.fields["skip_security_rules"].choices]
...
class SecurityRuleSkipTaskTest(TestCase):
    ...
    def test_skipped_rule_ids_forwarded_to_scan(self, mock_scan):
        ...
        run_security_scan_task(
            self.version.pk, skipped_rule_ids=[self.warning_rule.id]
        )
